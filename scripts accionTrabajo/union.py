...
df_desarrolladores = pd.read_csv('accion_trabajo_desarrolladores.csv')
df_analista_datos = pd.read_csv('accion_trabajo_analista_datos.csv')
df_qa = pd.read_csv('accion_trabajo_qa.csv')
...
columnas_esperadas = ['index', 'titulo', 'empresa', 'ubicacion', 'salario', 'experiencia', 'jornada', 'modalidad', 'fecha_publicacion', 'caracteristicas', 'descripcion']
...
# CAMBIO 1: Extraer solo las columnas necesarias (sin index y fecha_publicacion)
columnas_trabajo = ['titulo', 'empresa', 'ubicacion', 'salario', 'experiencia', 'jornada', 'modalidad', 'caracteristicas', 'descripcion']
...
columnas_finales = ['titulo', 'empresa', 'ubicacion', 'salario', 'experiencia', 'jornada', 'modalidad', 'caracteristicas', 'descripcion', 'Area']
...
# CAMBIO 5: Guardar el archivo combinado con nombre específico para AcciónTrabajo
df_combinado.to_csv('accion_trabajo_todos_empleos_tech.csv', index=False, encoding='utf-8-sig')

print(f"\n✅ Archivo guardado exitosamente como 'accion_trabajo_todos_empleos_tech.csv'")
